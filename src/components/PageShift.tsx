...
const PageShift = (props:any) => {
  ...
  return (
    <button
      ...
      className={`absolute z-30 max-w-fit m-auto left-0 right-0 group  border p-1  md:p-2 rounded-full flex items-center justify-center md:opacity-40 hover:opacity-80 transition-all  ${props.way === 'up'?'max-md:bottom-10 md:top-0 mt-2':'bottom-0 mb-2'}`}
    >
